    ...
    public partial class DownFileProcess : WindowBase
    {
        ...
        public DownFileProcess(string callExeName, string updateFileDir, string appDir, string appName, string appVersion, string desc)
        {
            ...
            this.Loaded += (sl, el) =>
            {
                ...
                this.versionLabel.Text = this.appName + "发现新的版本(" + this.appVersion + ")";
            ...
            client.DownloadDataCompleted += (sender, e) =>
            {
                ...
                System.Threading.ThreadPool.QueueUserWorkItem((s) =>
                {
                    ...
                    f = () =>
                    {
                        ...
                        //将删除文件的功能移到主程序中，不然删除不彻底，无法删除更新程序自身。
                        //try
                        //{
                        //    MessageBox.Show("updateFileDir----->" + updateFileDir);
                        //    //清空缓存文件夹
                        ...
                        //        }
                        //    }
                        //    MessageBox.Show("rootUpdateDir----->"+rootUpdateDir);
                        //}
                        //catch (Exception ex)
                        //{
                    ...
                    try
                    {
                        f = () =>
                        {
                            ...
                            alert.Loaded += (ss, ee) =>
                            {
                                ...
                                alert.YesButton.Height = 30;
                                alert.NoButton.Height = 30;
                            };
                            alert.Width=300;
                            alert.Height = 200;
                            alert.ShowDialog();
        ...
        public void UpdateProcess(long current, long total)
        {
            ...
            rectProcess.Width = ((float)current / (float)total) * 430;
        }
